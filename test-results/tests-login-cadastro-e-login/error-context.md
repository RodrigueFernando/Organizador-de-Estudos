...
- Name: tests/login.test.js >> cadastro e login
- Location: tests/login.test.js:17:1
...
```yaml
- generic [ref=e3]:
  - heading "ORGANIZADOR DE ESTUDOS" [level=2] [ref=e4]
  - generic [ref=e5]:
    - generic [ref=e6]: "Email:"
    - textbox "Digite seu e-mail" [ref=e7]: fernando@gmail.com
  - generic [ref=e8]:
    - generic [ref=e9]: "Senha:"
    - textbox "Digite sua senha" [ref=e10]: "33747467"
  - link "Esqueci minha senha" [ref=e11] [cursor=pointer]:
    - /url: "#"
  - generic [ref=e12]:
